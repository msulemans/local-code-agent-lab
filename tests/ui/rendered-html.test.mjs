...
assert.match(html, /A3 resolved 1\/3 · controls sound/);
...
assert.match(js, /Generalization complete · 1\/3 resolved/);
assert.match(js, /Pylint and Sphinx FIX_INCOMPLETE/);
assert.match(js, /both gold controls 1\/1/);
assert.match(js, /Sphinx retry used 15 tools with no budget crash/);
