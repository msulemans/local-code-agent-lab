...
assert.match(html, /Flask solved · Sphinx budget fixed/);
...
assert.match(js, /m-luna-generalization-a3-v1/);
assert.match(js, /243 unit tests green/);
assert.match(js, /gold control/);
assert.match(js, /reserves the verification slot/);
